...
**Write your ANSWER HERE** This is due to the fact that people who might tend to take surveys more often are those who are more highly educated than those who aren't responding to the surveys, the general public. This would cause some groups to be overrepresented, like college grads, while other groups are underrepresented. 
...
**Write your ANSWER HERE** College graduates are much more likely vote, with approximately 93% set to vote in this upcoming election.
...
**Write your ANSWER HERE** The percentages didn't chnage very much, however, the High school or less category changed the most.

2. Why might the weighted results be considered more accurate than the unweighted results?

**Write your ANSWER HERE** The weighted results account for some education levels being over or underrepresented. Weighted results will allow for a true analysis.
...
**Write your ANSWER HERE** Understanding survey weighting is key for journalists because unweighted results may give an inaccurate idea of what the data is representing. Knowing what the weights mean will allow for the journalists to better comprehend the results and write correctly about them.

2. How might the differences between weighted and unweighted results affect how you would report on this data?

**Write your ANSWER HERE** If you reported on the unweighted data, it would skew how you interpret it. In this exercise if you had just reported on the unweighted numbers you wouldn't capture the true nature of the voting tendencies of people based on their education level. The journalist would've had numbers that indicated high school or less educated people vote more than they actually do.
...
**Write your ANSWER HERE** I would want to know if there were any other factors that impacted the weigths. Was it soley education level or were there other variables in play. I would also want to the know the weights for each of the categories relative to 1. Was the weight on college educated people something like 0.8?
