...
spotify |>
  ggplot() +
  geom_histogram(aes(x=danceability), bins = 7)
```
...
This distribution is slightly skewed to the left, meaning more of the data sits on the right side of the mean. The mean tells us what the average danceability score is for all of the songs in the dataset, while the standard deviaiton tells us that 68% of the songs are within one standard deviation of the mean.

Pitch: Rap songs tend to have more "danceability" than other genres of music.
