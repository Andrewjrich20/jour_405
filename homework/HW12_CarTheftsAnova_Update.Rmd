...
**WRITE YOUR ANSWER HERE**: The mean theft rate almost tripled as it was 23.19 during the pre-spike and 59.95 during the spike year. However, there were only 12 observations in the spike year compared to 71 in the pre-spike, which could skew the data. 
...
**WRITE YOUR ANSWER HERE** The chart shows the clear increase in car thefts during the spike period. However, there is a definite increase leading up to the spike year as well with car thefts in 2022 seing a drastic spike. My new title would be: Monthly Car Thefts Before, During and After the Spike Period.
...
- **Null Hypothesis (H0)**:   The theft rates do not differ between the pre-spike, spike and post-spike periods.

- **Alternative Hypothesis (H1)**: The theft rate during the spike period differs from that of the pre and post-spike periods.
...
**WRITE YOUR ANSWER HERE** Yes, there are real differences in the average rates between the time periods. The results are clearly signigicant because the p-value is much much lower than the threshold. Also, the 3 asteriks indicate the significance of the results.
...
**WRITE YOUR ANSWER HERE** The Tukey's test shows the clear differences between the theft rates across the three time periods. The biggest differences come between the spike year and pre-spike period as well as the pre and post-spike period. That difference between the pre and post-spike is significant because we can see the p value is at 0. The chart also shows this difference clearly between the pre-spike period and post-spike period. Headline: Car theft rates spike massively in 2023 compared to previous numbers.
Lede: Car thefts have increased dramatically in 2023, seeing nearly triple the amount of thefts compared to 2017-2021.