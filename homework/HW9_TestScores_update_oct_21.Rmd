...
After looking at the score data, it is clear that the test scores have improved following the new program run by the school. I can tell because the new test scores are all above the prior mean of 72.6.
...
New reading program causes boost in test scores.
...
**Hypotheses:**
Null: The new reading program did not change the students' reading scores.
Alternative: The new reading program changed the students' reading scores.
...
The P value tells us that the data before and after the implementation of the reading program are different. This would tell us to reject the null hypothesis. The p value doesn't tell us exactly how much different the new data is after the reading program is started. The results tell us that there is an extremely small chance that the reading program did not change the reading scores of students. 
...
A new reading program has improved the reading scores of students across the school district. Before the program was implemented the average test score was a 72.6. The new average for test scores following the start of the program is 75.75. There is evidence to support the superintendent's claim. 
...
I think the lower bound is important to look at because seeing what the worst test score is will truly give perspective as to the effectiveness of the new reading program. Also, the percent change will be important to look at along with the p value. 
