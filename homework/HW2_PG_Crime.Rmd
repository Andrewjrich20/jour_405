...
ANSWER HERE: The categories are more specific in this data set than most. For example instead of simply grouing all theft into one category it has theft from auto as well. Also, it specifies whether or not a stolen car was retrieved or not. I think the assault with a weapon category is particulalry important from a reporting perspective because people tend to wonder whether there was a weapon used or not. The 'Accident' category is very vague and makes it more difficult to fully interpret the data because that could mean many things. 
...
ANSWER HERE: The categories that have the highest average are 'Accident', 'Auto Stolen', and 'Theft from Auto'. The categories with the lowest averages are 'Homicide', 'B&E other', and 'Sex Offense'. This data tells us that the pattern of crime in Prince Geroge's County revolves heavily around vehicles. I am curious about the 'Robbery Residential' category because it is missing some data points and it was not able to calculate the total number of incidents and the average.
...
ANSWER HERE: For the most part I would disagree with the theory that crime is more likely to occur in the summer months. For many of the categories the percent change was negative compared to the average number of incidents. One pattern I noticed was that homicide had a positive percent change for each of the summer months. It is possible to say that homicide is more likely to occur in the summer, not necessarily crime.
...
ANSWER HERE: Crimes involving vehicles have the highest average number of incidents of any crime in Prince Geroge's County. Accidents have the highest average number of incidents with 481 per month. Also, stolen vehicles average nearly 400 incidents per month, which is the second highest of any category of crime in PG County. The crimes involving vehicles drastically outweigh any other crime in Prince George's County.
