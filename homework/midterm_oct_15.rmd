...
**Write your answer here:**
I got stuck here trying to load janitor and it then wouldn't let me run the code.
...
**Write your answer here:**
1. I would use measures like mean so I could see what the averge response time is. I would then calculate the change over time in that average.
2. A scatterplot would help to better understand the data.
3. I would do reporting on how many calls were being received and the number of people that are actually answering the phones.
