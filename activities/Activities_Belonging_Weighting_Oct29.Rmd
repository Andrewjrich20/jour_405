...
**Write your answer here:** I think the way that they grouped people for this survey is a little concerning for the significance of the data. They grouped all races with a small amount of respondents into one group with can skew the results of the survey. Also having only 3% of the respondents being men compared to 38% being women could also skew the results.
...
1. What is the range of weights in this dataset? **Write your answer here:** 0.2298 to 3.0386

2. What does it mean when a respondent has a weight of 0.23? What about 3.04? **Write your answer here:** A weight of 0.23 means that the respondent is overrepresented and a weight of 3.04 means the respondent is severely underrepresented.

3. Why might some respondents be weighted more heavily than others? **Write your answer here:** Some respondents are more likely to respond than others so to even out the impact some will be weighted heavier than others.
...
1. Which voter category shows the biggest difference between weighted and unweighted results? **Write your answer here:** The biggest difference between weighted and unweighted results is the rarely/never voter category.

2. How might these differences affect reporting on likely voter turnout? **Write your answer here:** It will affect reporting because the weight gives a much more realistic idea of what voters will be turning up to vote.

3. Why do you think these differences exist? What does this tell us about who might be over or under-represented in the sample? **Write your answer here:** The differences exist because people who always vote will be overrepresented compared to those who rarely/never vote. Withought weighting, people who always vote will have more influence on the results.  
