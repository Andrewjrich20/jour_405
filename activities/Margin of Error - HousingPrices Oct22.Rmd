...
Sample size 100: MoE = 10%
Sample size 800: MoE = 3.53%
...
The headline 'Majority Supports New City Policy' is not justified because after subtracting the margin of error, none of the sample sizes have a percentage of support over 50%. If you add the margin of error, the headline could be true but it is not a guarantee that the margin of error will be added. So saying the majority supports the policy would not be true in some cases.

A new headline could be 'New City Policy Gains Support'.
...
Based on the data, there is evidence that the building of the new transit line has increased the value of the homes in the area. The statistical evidence allows us to make a confident conclusion about how the transit lines effects the price of homes in the area. 
