...
**Your answer**:
One example of data that would not be normally distributed is home prices in a particular area. Outliers, on both ends, would drastically skew the distribution. Another example could be the lifetime of product durabillity. Similar to home prices, outliers on both ends will make the data slightly more difficult to interpret. For home prices, the median would be a more valid statistical measure because of the outliers that would be present. For product durability, I believe the mode would provide an interesting conclusion and might give more information for a reporter to build a story around.
...
**Answer**:
Maryland Women's Volleyball team is in the 95th percentile of all of the womens volleyball teams in the NCAA in terms of aces. UTEP has the most aces with 263, while Maryland has 223 aces. 223 aces ranks 17th among all of the NCAA womens volleyball teams. 
...
**Answer**:
The distribution is slighlty skewed towards the higher end of the data. However, the majority of the data is covered by one standard deviation. Within that standard deviation is about 68% of the total data in the set.
