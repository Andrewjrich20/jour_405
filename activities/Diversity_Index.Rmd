...
**ANSWER HERE** Baltimore City and Germantown stand out as the most diverse cities in the database.
...
**ANSWER HERE** Summerfield has the highest race probability. This is because Summerfield has a relatively low population and has a lot of diversity within that low population.
...
**ANSWER HERE** The cities with the lowest Hisp_Prob scores have a relatively even amount of people who are and who are not hispanic.
...
**ANSWER HERE** The top 3 cities are Langley Park, Wheaton and Adelphi. They are all relatively close to each other within an extremely diverse area around Prince Geroge's and Montgomery County. Lake Shore is the least diverse city. It is located in Anne Arundel County south of Baltimore by the Eastern shore. 
...
**ANSWER HERE** 
Headline: Suburban D.C. shows the most diversity
Lede: Washington D.C. suburbs have the highest diversity index with cities like Langley Park and Wheaton showing the highest index.
I would talk to city council officials and ask them about why such diversity exists in the suburbs of D.C. I would present the diversity index statistics and ask them about why they think these numbers exist.
