...
**WRITE YOUR ANSWER HERE** It doesn't seem as though there is much of a relationship between Farms percentages and the percentage of people who met or exceeded the math scores. If there is a relationship between these two variables it is slightly positive but quite weak.
...
**WRITE ANSWER HERE** This model would not be worth using because at the 95% confidence level the results of the test are not significant. This tells us that there is really no relationship between the FARMS percentage and math scores.
...
**WRITE YOUR ANSWER HERE** The largest differences between the predicted result and the actual math scores are Whitemarsh Elementary (34.90), Gulph Elementary (31.34) and Crooked Billet Elementary (31.11).
...
**WRITE YOUR ANSWER HERE** I would say that there is no real relationship between the FARMS percentage and the absolute residuals for these schools. This would influence my pitch as the school board member is not speaking from factual information and the real story is something very different.
